...
const Admin = () => {
  return (
    <div className="min-w-full h-full pb-8" >
      ...
      <div className="max-w-[98%] h-full mx-auto">
        <Tabs defaultValue="alumni" className="size-full">
          <TabsList className="w-full">
            <TabsTrigger className="w-2/5 data-[state=active]:w-3/5" value="alumni">Alumni Management</TabsTrigger>
            <TabsTrigger className="w-2/5 data-[state=active]:w-3/5" value="role">Role Management</TabsTrigger>
          </TabsList>
